...
def main():
    ...
    table.grid(row=1, column=0, columnspan=4, sticky="nsew", padx=140, pady=140)

    # Button zum Berechnen
    calculate_button = ttk.Button(root, text="Berechnen", command=table.calculate)
    calculate_button.grid(row=2, column=0, columnspan=2, sticky="nsew", padx=70, pady=70)

    # Button zum Löschen
    clear_button = ttk.Button(root, text="Löschen", command=table.clear_entries)
    clear_button.grid(row=0, column=0, columnspan=4, sticky="nsew", padx=70, pady=70)
